...
if (isset($_GET["error"])) {
    if ($_GET["error"] == 1) {
        $massage->setErrorMassage("This email is already exists.");
    } elseif ($_GET["error"] == 2) {
        $massage->setWarningMassage("Check the passwords you entered.");
    } elseif ($_GET["error"] == 3) {
        $massage->setErrorMassage("Sorry, only PDF files are allowed.");
    }
}
if (isset($_GET["msg"])) {
    if ($_GET["msg"] == 1) {
        $massage->setSuccessMassage("<hr>Successfully registered.<hr>");
    }
}
?>
            ...
            <div class="p-5">
                ...
                <div class="text-center">
                    <h4 class="text-dark mb-4" style="font-size: 31.704px;"><strong><span
                                    style="color: rgb(0, 115, 139);">Create an Admin Account</span></strong></h4>
                </div><!-- Start: Register Form -->
                <form class="user" action="process/admin.php" method="post"><!-- Start: Names -->
                    <div class="row mb-3">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input class="form-control form-control-user" type="text" name="fname"
                                   placeholder="First Name" required="" style="background: #ababab;">
                        </div>
                        <div class="col-sm-6">
                            <input class="form-control form-control-user" type="text" name="lname"
                                   placeholder="Last Name" required="" style="background: #ababab;">
                        </div>
                    </div><!-- End: Names --><!-- Start: Username -->
                    <div class="mb-3">
                        <span id="check_username"></span>
                        <input class="form-control form-control-user" type="text" id="userName" name="uname"
                               placeholder="Username" oninput="checkUsername()" required=""
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-user" type="email" id="email" name="email"
                               placeholder="Email Address : admin.<<yourname>>@mhs.com" required="" value=""
                               style="background: #ababab;" readonly>
                    </div>
                    ...
                    <button class="btn btn-primary d-block btn-user w-100 reg-btn" id="submitBtn" name="regAdmin"
                            type="submit" style="border-style: none;">
                        <strong>Register Account</strong>
                    </button>
                    <a href="admin_action.php">
                        <span class="btn btn-primary d-block btn-user reg-btn mt-3" style="border-style: none;width: 10vw; text-decoration: none !important;">
                            <strong><< BACK</strong>
                        </span>
                    </a>
...
<script>
    $(document).ready(function () {
        $('#userName').on('input', function () {
            let adminUsername = $(this).val();
            let adminMail = "admi." + adminUsername + "@mhs.com";
            $('#email').val(adminMail);
        });
