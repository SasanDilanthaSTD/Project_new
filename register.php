        ...
        <div class="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 reg" style="border-radius: 9px;background: #ffffffb0;">
            <div class="p-5">
                ...
                <form class="user" action="process/signupProcess.php" method="post" enctype="multipart/form-data"><!-- Start: Names -->
                    ...
                    <div style="margin-bottom: 10px;text-align: center;color: rgb(0, 115, 139);"><!-- Start: 1 Row 3 Columns -->
                        <!-- <div class="container" >
                        ...
                        <div id="pdf-input" style="display: none;text-align: center;align-items: center;align-content: center;margin-left: 7vw">
                            <label for="pdf-file">Upload Your CV (as PDF file):</label>
                ...
                <div style="text-align: center;">Already have an account?<a class="forgot-password" href="login.php" style="font-size: 14px;text-decoration: none"><span
                                style="color: dodgerblue; font-weight: bold"> Login</span></a>
                </div>
            </div>
        </div>
    </div>
