...
if ($possition1 == "patient") {
    ...
    $user2 = $userObj->getDoctorsAndCounselors();
...
<div><!-- Start: Navbar Right Links -->
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"
                                  style="padding-bottom: 0px;margin-top: 0px;padding-top: 0px;"><img src="assets/img/logo.png" style="width: 109px;"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                ...
                </ul><a class="btn btn-primary ms-md-2 loginbtn" role="button" href="process/logout.php" style="border-style: none;">
...
<div style="background: url(&quot;assets/img/doctor.jpg&quot;) no-repeat;background-size: cover;">
    <h1 style="text-align: center;color: rgb(250,250,250);margin: 0px;padding: 6px;padding-top: 40px;padding-bottom: 40px;">
        MHS CHATZ&nbsp;&nbsp;<i class="fa-regular fa-comments fa-bounce"></i></h1>
</div><!-- End: heading -->
            ...
            <div class="col-lg-4 col-xl-4" style="width: 310px;"><!-- Start: Me -->
                <div class="row">
                    <div
                        ...
                        <h5 class="mr-auto my-auto"><?php echo $user->firstname." ".$user->lastname;?>&nbsp; &nbsp;&nbsp;</h5><img width="46" height="46" src="<?php echo $user->profile_photo;?>" style="border-radius: 25px;">
                    </div>
                ...
                <div class="row px-3 py-2">
                    <div class="col" style="border-radius: 25px;box-shadow: 0px 0px 5px var(--gray-dark);">
                        <form class="d-flex align-items-center px-2">
                            ...
                            <input class="shadow-none form-control flex-shrink-1" type="search" id="myInput" placeholder="Search for names..." onkeyup="search();" style="border-color: #00454f;border-radius: 12px">
                    ...
                    <div class="col" style="overflow-x: none;overflow-y: auto;max-height: 32.5rem;height: auto;">
                        <ul class="list-unstyled">
                            ...
                            foreach ($user2 as $doctors){
                                if ($doctors->status == "offline") {
                                    $newStatus = "offline";
                                }else{
                                    $newStatus = "";
                                }
                                ?>
                                <a href="chatprofile.php?uname=<?php echo $doctors->username;?>" style="text-decoration: none">
                                    <li style="cursor:pointer;">
                                        <div class="card border-0" id="myTable" style="margin: 5px;border-radius: 20px;">
                                            <div class="card-body chat-card">
                                                <h6 class="text-nowrap text-truncate card-title"><img src="<?php echo $doctors->profile_photo;?>" width="48" height="47" style="width: 46px;height: 46px;border-radius: 25px;">&nbsp; &nbsp; <?php echo $doctors->firstname." ".$doctors->lastname;?></h6>
                                                <div class="status-dot" style="display: flex">
                                                    <i class="fa-solid fa-circle <?php echo $newStatus;?>"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="col  d-lg-block d-xl-block"><!-- Start: In Chat With -->
                <div class="row">
                    <div class="col d-flex align-items-lg-center align-items-xl-center border-start border-muted greenrowborder"
                         style="background: rgb(0,69,79);height: 4rem;color: var(--bs-body-bg);"><button
                ...
                <div class="row" id="pic-and-name" style="text-align: center;">
                    <div class="col">
                        <div class="row">
                            <div class="col"><img width="300" height="289" src="assets/img/chatz2.png"
                ...
                <div class="row px-3 py-2 greenrowborder" style="background: rgb(0,69,79);margin-top: 115px;color: var(--bs-body-bg);">
                    ...
                    <div class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-2 text-nowrap d-md-flex justify-content-md-end p-0">
                        <!--                        <button class="btn btn-light h-100 w-auto" type="button" style="border-radius: 10px;"><i-->
