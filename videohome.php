...
<!--                                    style="border-radius: 13px;border-style: none;">-->
            ...
            <div class="col  d-lg-block d-xl-block"><!-- Start: In Chat With -->
                ...
                <div class="row" id="pic-and-name" style="text-align: center;">
                    <div class="col">
                        <div class="row">
                            <div class="col"><img width="300" height="289" src="assets/img/webcam.png"
                                                  style="margin-top: 86px;margin-bottom: 20px;"></div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <h1 style="margin-bottom: 10px;color: rgb(0,69,79)">Keep your webcam connected</h1>
                            </div>
                        </div>
                    </div>
                </div><!-- Start: Box Message -->
                <div class="row px-3 py-2 greenrowborder" style="background: rgb(0,69,79);margin-top: 68px;color: var(--bs-body-bg);">
