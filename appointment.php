        ...
        <div class="card-body">
            ...
            <form class="form" action="process/appointment.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="p_name"  placeholder="Enter the Patient's Username">
                </div>
                <div class="form-group">
            ...
            <div>
                ...
                <button class="btn btn-success" type="submit" name="btn_chanel" style="border-style: none;" id="pay">Chanel a Doctor</button>
            </div>
            </form>
        </div>
