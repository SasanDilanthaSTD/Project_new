...
<head>
    ...
    <link rel="stylesheet" href="assets/css/for_index.css">
        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php"
               style="padding-bottom: 0px;margin-top: 0px;padding-top: 0px;">
                <img src="assets/img/logo.png" style="width: 109px;">
            </a>
        </div>
            ...
            <div class="col-md-12" style="background: rgba(255,255,255,0.58);"><!-- Start: Intro -->
                <div class="intro">
                    <div style="text-align: center;margin-bottom: 0px;margin-top: 30px;">
                        <img src="assets/img/logo.png" style="width: 230px;padding-top: 20px;padding-bottom: 20px;">
                    </div>
                </div><!-- End: Intro -->
            </div>
        </div>
        <div class="row">
            <div class="col-md-12" style="background: rgba(255,255,255,0.58);">
                <div style="padding-left: 0px;text-align: center;padding-top: 0px;margin-bottom: 50px;margin-top: 0px;">
                    <div style="margin-bottom: 30px;">
                        <a href="home.php">
                            <button class="btn btn-primary tada animated first-buttongroup" type="button"
                                    style="border-style: none;height: 58px;width: 248.9px;font-size: 22px;margin-bottom: 20px;">
                                <strong>Visit MHS</strong>
                            </button>
                        </a>
                    </div>
                    <div>
                        <h6>Admin, Doctors &amp; Counselors</h6>
                    </div>
                    <div>
                        <a href="login.php">
                            <button class="btn btn-primary first-buttongroup" type="button" style="border-style: none;">
                                Let's Heal
                            </button>
                        </a>
                    </div>
