...
$receiverUsername = $_GET["uname"];
//echo $receiverUsername;
$user2 = $userObj->getUserByUsername($receiverUsername);
//echo $user2->lastname;
            ...
            <div class="col  d-lg-block d-xl-block">
                ...
                <div class="row">
                    <div class="col d-flex align-items-lg-center align-items-xl-center border-start border-muted greenrowborder"
                        ...
                        <img width="46" height="46" src="<?php echo $user2->profile_photo;?>" style="border-radius: 25px;">&nbsp;&nbsp;<h5 class="mr-auto my-auto"><?php echo $user2->firstname . " " . $user2->lastname;?></h5><span class="my-auto" style="font-size: 13px;"> &nbsp;(<?php echo $user2->status;?>)</span>
                    </div>
                </div>
                <!-- End: In Chat With -->
                ...
                <!-- Start: Box Message -->
                <div class="row px-3 py-2 greenrowborder" style="background: rgb(0,69,79);margin-top: 20px;color: var(--bs-body-bg);">
                    <div class="col-9 col-sm-10 col-md-10 col-lg-10 col-xl-10" ">
<!--                        <h6 style="text-align: center;padding-top: 1px;"></h6>-->
                        <form action="#" class="typing-area">
                            <input type="hidden" name="outgoingUname" value="<?php echo $user->username;?>">
                            <input type="hidden" name="incomingUname" value="<?php echo $user2->username;?>">
                            <input type="text" name="message" class="input-field" placeholder="Type a message here...">
                            <button class="btn btn-light typing-area-btn" type="submit"><i class="fa-solid fa-paper-plane fa-fade"></i></button>
                        </form>
                    </div>
