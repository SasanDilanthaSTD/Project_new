...
if ($_SERVER['REQUEST_METHOD'] === 'GET'){
    if (isset($_GET['key'])){
        ...
        // set up bd data and payhere data
        $description = "This payment for channeling a doctor";
        $pay_id = $pay->create_pay_id();
    }
}
        ...
        <div class="card-body">
            ...
            <form class="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?=$d_name ?>" disabled>
                </div>
                <div class="form-group row">
                    <label class="col-md-12">Description</label>

                    <div class="col-md-4">
                        <input type="text" class="form-control"  required="" placeholder="Description" value="<?=$description ?>">
                    </div>
                </div>
                <div class="row">
        ...
        <div class="container text-muted py-4 py-lg-5">
            <ul class="list-inline" style="margin-top: -25px;">
                <li class="list-inline-item me-4"><a class="link-secondary" href="#"><br><span
                            style="color: RGBA(86,94,100,var(--bs-link-opacity,1)) ;">mentalhealthservice@gmail.com</span></a></li>
                <li class="list-inline-item me-4"><a class="link-secondary" href="#"><br><span
