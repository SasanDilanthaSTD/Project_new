...
<div><!-- Start: Navbar Right Links -->
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="home.php" style="padding-bottom: 0px;margin-top: 0px;padding-top: 0px;"><img src="assets/img/logo.png" style="width: 109px;"></a>
        </div>
            ...
            <div class="col-md-12" style="background: rgba(255,255,255,0.58);"><!-- Start: Intro -->
                <div class="intro">
                    <div style="text-align: center;"><img src="assets/img/logo.png"
                                                          style="width: 168px;padding-top: 20px;padding-bottom: 20px;"></div>
                </div><!-- End: Intro -->
            </div>
        </div>
