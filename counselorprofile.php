...
<body style="background: url(assets/img/conselorbg.jpg) top / cover no-repeat fixed, rgb(63,70,79);">
<!-- Start: nav bar -->
<div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link itemnew" href="contactUs.php"
...
if (isset($_GET["msg"])) {
    if ($_GET["msg"] == 1) {
        $massage->setSuccessMassage("<hr>Profile Updated Successfully.<hr>");
    }elseif ($_GET["msg"] == 2){
        ...
        <div class="card mb-3" style="border-radius: .5rem;">
            <div class="row g-0">
                ...
                <div class="col-md-4 gradient-custom text-center text-white"
                    ...
                    <i class="fa-solid fa-user-nurse fa-bounce" style="margin-bottom: 15px"></i>
                </div>
                <div class="col-md-8">
                    <div class="card-body p-4">
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="container text-end" style="text-align: center">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary loginbtn" type="button" style="border: none; margin-top: 10px" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        Add a quote about your self
                                    </button>
                                </div>
                                <p style="font-size: 12px;text-align: center">This will appear to the patient. <span style="color: red">(maximum 15 words)</span></p>
                            </div>
                            <form action="process/descriptionUpdate.php" method="POST">
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title h3" id="exampleModalLabel">Add Your Quote</h5>
...
<!--                                                    <br />-->
                                            ...
                                            <div class="modal-footer">
                                                <p id="word_limit_warning" style="color: red"></p>
                                                <script>
                                                    const descriptionInput = document.getElementById("description");
                                                    const wordLimitWarning = document.getElementById("word_limit_warning");
                                                    ...
                                                    descriptionInput.addEventListener("input", function () {
                                                        ...
                                                        if (wordCount > 15) {
                                                            wordLimitWarning.textContent = "You are exceeding the word limit. ";
                                                        } else {
                                                            wordLimitWarning.textContent = "";
                                                        }
                                                    });
                                                </script>
                                                ...
                                                <button type="submit" name="save" id="save" class="btn fw-bold loginbtn" style="color: white">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container-fluid main">
                <div class="text-center main-text">
                    ...
                    <div class="c2a-btn footer-c2a-btn">
                        <h3 style="color: #00738b; font-weight: bold;padding-bottom: 0px" >Connect with<span style="color: #abc7cb"> Patie</span><span style="color: #1a97ad"></span>nt</h3>
                        ...
                        <div class="btn-group btn-group-lg" role="group" aria-label="Call to action">
                            <a type="button" class="btn btn-default btn-lg" href="chathome.php" style="font-weight: bold">MHS Chat</a>
<!--                            <span class="btn-circle btn-or">or</span>-->
<!--                            <a type="button" class="btn btn-default btn-lg" href="videohome.php" style="font-weight: bold">Video Chat</a>-->
                        </div>
                    </div>
                </div>
            </div>
