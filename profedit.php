...
<div>
    ...
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#" style="padding-bottom: 0px; margin-top: 0px; padding-top: 0px"><img src="assets/img/logo.png" style="width: 109px"/></a>
            <a href="<?php echo $link; ?>">
                <button class="btn btn-danger form-btn loginbtn" data-bss-hover-animate="pulse" type="reset" style="border-style: none">
                    <i class="fa-solid fa-backward fa-beat-fade"></i>&nbsp&nbsp Back to Profile
                </button>
            </a>
        </div>
    </nav>
...
if (isset($_GET["msg"])) {
    if ($_GET["msg"] == 1) {
        $massage->setErrorMassage("<hr>JPG, JPEG, PNG, HEIC files are only allowed.<hr>");
    }
}
?>
<div class="content">
